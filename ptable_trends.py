# This code has been written by Andrew S. Rosen
# and is available at https://github.com/arosen93/ptable_trends
...
def ptable_plotter(
    ...
    ----------(tvman edits)----------
    png_fname : str
        A filename to save png to, if not None, the plot will be saved as a .png file to the given path.
    color_bar_name : str
        A color bar title name.
    ----------(tvman edits)----------
    ...
    if png_fname:
        export_png(p, filename=png_fname)
